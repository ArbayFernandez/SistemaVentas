...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Árticulo: {{ $articulo->nombre}}</h3>
			@if (count($errors)>0)
    	...
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"> 
     		 <div class="form-group">
            	...
            	<input type="text" name="descripcion" value="{{$articulo->descripcion}}" class="form-control" placeholder="Descripción del árticulo...">
            </div>  		
    	</div> 
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"> 
     		 <div class="form-group">
