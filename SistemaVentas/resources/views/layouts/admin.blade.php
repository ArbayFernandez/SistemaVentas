...
<html>
  <head>
    ...
    <title>Estación de Servicio</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Ms</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Multiservicio</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Arbay Fernández</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('ventas/cliente')}}"><i class="fa fa-circle-o"></i> Cliente</a></li>
              </ul>
            </li>
